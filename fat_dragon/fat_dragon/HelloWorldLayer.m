...
- (void) foodAnimation1: (ccTime)dt
{
    ...
    image_1.position=ccp(image_1.position.x+5*sin(game_time), image_1.position.y*(1.00-acceleration));
    image_2.position=ccp(image_2.position.x+5*sin(game_time), image_2.position.y*(1.00-acceleration));
    acceleration+=0.02;
    if (image_1.position.y<14.5&&image_2.position.y<14.5) {
